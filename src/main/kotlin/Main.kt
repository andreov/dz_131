...
fun minuteWord(numberSec: Int): String {
    ...
    val word3 = "был(а) в сети $minute минут назад"
...
fun hourWord(numberSec: Int): String {
    ...
    val word3 = "был(а) в сети $hour часов назад"
...
// Правильная конструкция кода
fun hourWord2(numberSec: Int): String =
when (val hour = numberSec / (60 * 60)) {
    2, 3, 4, 22, 23, 24 -> "был(а) в сети $hour часа назад"
